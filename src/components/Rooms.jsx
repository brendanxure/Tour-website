...
const Rooms = () => {
  return (
    <div className='w-full my-20 mb-[40vh] relative md:mt-[10vh] px-10 h-full'>
        <div className='max-w-[1500px] mx-auto flex relative flex-col md:flex-row h-[60vh] bg-blue-100 px-4'>
            ...
            <div className='grid grid-cols-2 w-full relative top-12 '>
